...
def alterar_funcionario():
    ...
    todos_funcionarios()
    # Solicita o nome atual do funcionário
    ...
    # Exibe os dados atuais do funcionário
    ...
    while True:
        ...
        if opcao == '1':
            ...
            # Atualiza o dicionário: cria uma nova entrada com o novo nome e move os dados
            # em seguida, remove a entrada antiga
            funcionarios[novo_nome] = funcionarios.pop(nome_atual)
            print(f'✅ Nome do funcionário "{nome_atual}" alterado para "{novo_nome}".\n')
            break

        elif opcao == '2':
            # Altera o valor da hora com validação
            while True:
                try:
...
def rodar_programa():
    ...
    while True:
        # A nova lógica: limpar, mostrar o menu e pedir a opção limpar_tela()
